...
mapOptions);
		 ...
		 var bizinfocontent = '<div class="infowindow"><img src="images/logo.jpg" style="width:175px;"/><br />'+addy+'<br /></div>'
       ...
       google.maps.event.addListener(bizmarker, 'click', function() {
		...
		document.getElementById("blng2").innerHTML = '' + (results[0].geometry.location.ib);	   
		  ...
		  var bizinfocontent2 = '<div class="infowindow"><img src="images/logo.jpg" style="width:175px;"/><br />'+addy2+'<br /></div>'
